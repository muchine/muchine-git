...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<s:url value='/resources/kendoui/styles/kendo.default.min.css'/>?version=<s:eval expression='@abcProp[\'version.cache\']'/>"/>
	...
	<script type="text/javascript" src="<s:url value='/resources/kendoui/js/kendo.all.min.js'/>?version=<s:eval expression='@abcProp[\'version.cache\']'/>"></script>
...
<body><div id="wrap" data-global="<%=request.getContextPath()%>">
	...
	<footer id="layFooter" class="layFooter">
        <ul>
            ...
            <li class="footerBxleft"><img src="/resources/abc/images/lglogo.jpg" alt="엘지로고" style="margin-right:50px; bottom:0" /><span class="dispNone">엘지로고</span></li>
            <li class="footerBxright">
                <ul>
                    <!-- <li class="footerBtn">고객센터</li>
                    <li class="footerBtn" style="border-left:none;">부가서비스</li> -->
                    <li>
