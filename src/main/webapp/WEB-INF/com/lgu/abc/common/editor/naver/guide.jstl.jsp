...
<body>
	<ul class="searchboxBg">
		...
		<li>2. 엑셀에서 붙여 넣었거나 에디터에서 직접 작성을 완료한 후 오른쪽 하단의 HTML 탭을 선택합니다.</li>
		<li>3. 화면에 HTML 코드가 보이면 전체 선택(Ctrl+A) 한 후 복사(Ctrl+C) 합니다.</li>
		<li>4. 팝업창 뒤편의 양식관리 작성 창으로 이동한 후, 편집기 왼쪽 상단의 소스 버튼을 클릭합니다.(네이버 에디터 창은 그대로 유지합니다)</li>
		<li>5. 소스 버튼이 클릭된 상태에서 붙여넣기(Ctrl+V)를 하고 왼쪽 상단의 소스 버튼을 다시 한 번 눌러서 클릭을 해제하면 화면이 보입니다.</li>
		<li>6. 양식의 내용을 확인하시고 추가 작업이 필요하시면 네이버 에디터 창으로 이동하여 위의 순서대로 작업합니다.</li>
	</ul>

	<iframe src="/resources/navereditor/SmartEditor2.html" width="950" height="580" scrolling="yes" frameborder="0"></iframe>
</body>
</html>